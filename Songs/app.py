    ...
    for filename in os.listdir(lyrics_folder):
        if filename.endswith('.txt'):
            ...
            with open(file_path, 'r', encoding='utf-8', errors = "replace") as file:
                ...
                lyrics = ''.join(lines[3:]).strip()  # 剩下的是歌詞
...
# 設定資料路徑
LYRICS_FOLDER = '/Users/cindychang/Documents/school/大三/IRTM/Final/all_lyrics'  # 歌詞資料夾路徑
CSV_FILE = '/Users/cindychang/Documents/school/大三/IRTM/Final/output_svm_param_1.csv'  # CSV 檔案路徑
